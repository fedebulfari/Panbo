...
enum Territories {
  ...
  ironMine2(GameItem(name: 'Miniera di Ferro', icon: '⛏️', gain: {Resources.rawIron: 5}, reqTerritory: {ironMine: true}, constructionCost:{Resources.wood:20,Resources.iron:2})),
	horse(GameItem(name: 'Cavalli', icon: '🐎', constructionCost: {Resources.wheat:6},turnCost: {})),
  sheep(GameItem(name: 'Pecore', icon: '🐑', gain: {Resources.wool: 1}, constructionCost: {Resources.wheat:4},turnCost: {})),
