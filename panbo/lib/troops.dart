...
enum Troops {
  ...
  trebuchet2(GameItem(name: 'Sfonda Muro', icon: '🎯', turnCost: {Resources.wheat:3}, constructionCost:{Resources.wheat:3, Resources.wood:20, Resources.iron:2}, reqBuilding: {Buildings.barracks: false})),
